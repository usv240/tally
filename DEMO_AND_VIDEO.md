...
| 3:35 to 3:45 | Live: the Agent trace. | "Every step is in the trace. A hundred and seventeen tests, and a vision eval at a hundred percent component recall over thirteen real photographs." |
